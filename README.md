...
|POST| '/api/v1/missions'              | Создать новую миссию          | {"mission_id": "M001", "name": "Венера", "goal": "исследование", "status": "запланирована<br/>"} |
|PUT| '/api/v1/missions/<mission_id>' | Полностью обновить миссию     | {"mission_id": ...", "name": "...", "goal": "...", "status": "..."}                              
